...
async function debugContact() {
  ...
  await page.goto(`${cleanUrl}/edit/forms/contact-info/new/`, { waitUntil: 'domcontentloaded' });
  ...
  writeFileSync('debug-contact.html', modalHtml);
  console.log('HTML do modal salvo em debug-contact.html');
