...
async function debugIntro() {
  ...
  await page.goto(`${cleanUrl}/edit/intro/`, { waitUntil: 'domcontentloaded' });
  ...
  writeFileSync('debug-intro.html', modalHtml);
  console.log('HTML do modal salvo em debug-intro.html');

  await linkedin.close();
}

debugIntro().catch(console.error);
